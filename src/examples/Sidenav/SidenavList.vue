<template>
  ...
  >
    <ul class="navbar-nav">
      <li class="nav-item">
        <sidenav-collapse navText="Главная" :to="{ name: 'Главная' }">
          <template #icon>
            <shop />
          </template>
        </sidenav-collapse>
      ...
      <li class="nav-item">
        <sidenav-collapse navText="Заказы" :to="{ name: 'Заказы' }">
          <template #icon>
            <office />
          </template>
        </sidenav-collapse>
      ...
      <li class="nav-item">
        <sidenav-collapse navText="Транзакции " :to="{ name: 'Транзакции ' }">
          <template #icon>
            <credit-card />
          </template>
        </sidenav-collapse>
      ...
      <li class="nav-item">
        <sidenav-collapse navText="Каталог Авто" :to="{ name: 'Каталог Авто' }">
          <template #icon>
            <office />
          </template>
        </sidenav-collapse>
      ...
      <li class="nav-item">
        <sidenav-collapse navText="Авторизоваться" :to="{ name: 'Sign In' }">
          <template #icon>
            <document />
          </template>
        </sidenav-collapse>
      ...
      <li class="nav-item">
        <sidenav-collapse navText="Зарегистрироваться" :to="{ name: 'Sign Up' }">
          <template #icon>
            <spaceship />
          </template>
        </sidenav-collapse>
