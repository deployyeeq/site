    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="mx-auto text-center col-lg-5">
          <h1 class="mt-5 mb-2 text-white">Добро пожаловать!</h1>
          <p class="text-white text-lead">
            Заполните эти формы для входа или создания новой учетной записи.
          </p>
        </div>
      </div>
    </div>
      ...
      <div class="mx-auto col-xl-4 col-lg-5 col-md-7">
        <div class="card z-index-0">
          <div class="pt-4 text-center card-header">
            <h5>Зарегистрируйтесь с помощью</h5>
          </div>
            ...
            <form role="form">
              ...
              <div class="text-center">
                <soft-button
                  ...
                  variant="gradient"
                  class="my-4 mb-2"
                  >Зарегистрироваться</soft-button
                >
              </div>
